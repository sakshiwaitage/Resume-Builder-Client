          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="absolute bottom-1 text-[11px] text-slate-400 group-hover:text-slate-500 transotion-all duration-300 px-2 text-center" style={{color: baseColor+'90'}}>
