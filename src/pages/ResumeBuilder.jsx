...
import { ArrowLeftIcon, User, FileText, FolderIcon, GraduationCap, Sparkles, Briefcase, ChevronLeft, ChevronRight, Share2Icon, EyeIcon, DownloadIcon, EyeOffIcon } from 'lucide-react';
            ...
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              ...
              <div className="space-y-6">
                ...
                {activeSection.id === "project" && (
                  <ProjectForm
                    data={resumeData.projects}          // ✅ Updated
                    onChange={(data) => setResumeData(prev => ({ ...prev, projects: data }))}  // ✅ Updated
                  />
                )}
              ...
              <button 
                onClick={() => toast.promise(saveResume(), {
                  loading: "Saving...",error: "Failed to save",
                })}
